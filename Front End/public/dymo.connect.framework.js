...
((goog.global = this),
          ...
          : goog.labs.userAgent.platform.isMacintosh()
            ...
            : goog.labs.userAgent.platform.isAndroid()
              ...
              : goog.labs.userAgent.platform.isChromeOS() &&
                (t =
                  (e = /(?:CrOS\s+(?:i686|x86_64)\s+([0-9.]+))/.exec(o)) &&
                  e[1]),
      t || ""
    );
  }),
  ...
  (goog.html.TrustedResourceUrl.createTrustedResourceUrlSecurityPrivateDoNotAccessOrElse =
    function (e) {
      ...
      return (
        (o.privateDoNotAccessOrElseTrustedResourceUrlWrappedValue_ = e),
        o
      );
    }),
  ...
  (goog.math.safeFloor = function (e, o) {
    return (
      goog.asserts.assert(!goog.isDef(o) || 0 < o),
      ...
      e instanceof goog.Uri
        ...
        : e && (t = goog.uri.utils.split(String(e)))
          ? ((this.ignoreCase_ = !!o),
            ...
            this.setFragment(
              t[goog.uri.utils.ComponentIndex.FRAGMENT] || "",
              !0
            ))
          : ((this.ignoreCase_ = !!o),
