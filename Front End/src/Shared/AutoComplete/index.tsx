...
const Autocomplete = (props: any) => {
  ...
  const {
    ...
    handleClick,
    touched,
  } = useAutocomplete(inputSearchRef.current, props.Inputs);
      ...
      <div className={`${props.parentDivClassName} position-relative`}>
        ...
        >
          ...
          {suggestions?.length > 0 && (
            <div
              className={`bg-white card position-absolute px-3 py-2 shadow-xs w-100 position-relative  ${!touched ? "d-none" : ""
                }`}
              style={{
                zIndex: 6,
                overflowY: "auto",
