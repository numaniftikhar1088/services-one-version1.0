...
const DatePicker = (props) => {
  ...
  const resultDataContext = useResultDataContext();
  const toxResultDataContext = useToxResultDataContext();

  // Determine which context to use based on the lisType
  const context =
    props.lisType === "ID" ? resultDataContext : toxResultDataContext;
  const { setSearchValue, setFilterData, filterData, open, setOpen } = context;
