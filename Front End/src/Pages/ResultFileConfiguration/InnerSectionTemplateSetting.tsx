    ...
    <>
      <div className="py-2">
        <div className="d-flex align-items-center gap-2 gap-lg-3 mb-2">
          <button
            id={`IDTemplateSettingExpandCancel`}
          ...
          >
            <button
              id={`IDTemplateSettingExpandSave`}
            ...
            >
              ...
              <TableBody>
                {data.map((row: any) => (
                  <TableRow>
                    <TableCell
                      id={`IDTemplateSettingExpandSystemCellName_${row.id}`}
                    >
                      {row.systemCellName}
                    </TableCell>
                    <TableCell>
                      <input
                        id={`IDTemplateSettingExpandCustomCellName_${row.id}`}
                        type="text"
                    ...
                    <TableCell>
                      <input
                        id={`IDTemplateSettingExpandCustomCellOrder_${row.id}`}
                        type="text"
                        className="form-control bg-white h-25px rounded-2 py-0 line-height-0 fs-8 fw-500 px-2"
                    ...
                    <TableCell className="text-center">
                      <div className="d-flex justify-content-center">
                        <div className="form-check form-switch">
                          <input
                            id={`IDTemplateSettingExpandSwitchButton_${row.id}`}
