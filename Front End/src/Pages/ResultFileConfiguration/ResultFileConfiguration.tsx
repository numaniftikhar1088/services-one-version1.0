...
import ResultDataSetting from "./ResultDataSetting";
...
const ResultFileConfiguration: React.FC<{}> = () => {
  const { t } = useLang();
          ...
          >
            <div className="mb-5 hover-scroll-x">
              ...
              >
                ...
                />
                <TabSelected
                  label={t("Result Data Setting")}
                  {...a11yProps(1)}
                  className="fw-bold text-capitalize"
                  id="ResultDataSetting"
                />
              </Tabs>
...
export default ResultFileConfiguration;
