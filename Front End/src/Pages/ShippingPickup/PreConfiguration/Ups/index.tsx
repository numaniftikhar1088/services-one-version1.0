          ...
          <div className="d-flex flex-wrap gap-3 justify-content-center mb-2 justify-content-sm-between align-items-center">
            <div className="d-flex align-items-center gap-2">
              <div className="d-flex align-items-center">
                ...
                <select
                  id={`ShippingPreConfigrationUPSRecords`}
              ...
              <div className="d-flex align-items-center gap-2">
                ...
                >
                  <button
                    id={`ShippingPreConfigrationUPSAddNew`}
                ...
                <StyledDropMenu
                  id={`ShippingPreConfigrationUPSBilkAction`}
                ...
                >
                  <MenuItem className="p-0">
                    <a
                      id={`ShippingPreConfigrationUPSExportAll`}
                  ...
                  <MenuItem className="p-0">
                    <a
                      className="p-0 w-200px text-dark"
                      id={`ShippingPreConfigrationUPSExportSelected`}
                      onClick={() => {
                        handleClose('dropdown2');
                      }}
                    >
            ...
            <div className="d-flex align-items-center gap-2 gap-lg-3 mb-2">
              <button
                id={`ShippingPreConfigrationUPSSearch`}
                onClick={() => {
                  setCurPage(1);
                  setTriggerSearchData(prev => !prev);
                }}
              ...
              <button
                ...
                id={`ShippingPreConfigrationUPSReset`}
              >
                <span>
                  <span>{t('Reset')}</span>
                </span>
              ...
              >
                <TableHead>
                  <TableRow className="h-40px">
                    ...
                    <TableCell>
                      <input
                        id={`ShippingPreConfigrationUPSSearchUserName`}
                        type="text"
                        name="userName"
                    ...
                    <TableCell>
                      <input
                        id={`ShippingPreConfigrationUPSSearchClintSecretKey`}
                        type="text"
                    ...
                    <TableCell>
                      <input
                        id={`ShippingPreConfigrationUPSSearchAccountNumber`}
                        type="text"
                        name="accountNumber"
                        className="form-control bg-white h-30px rounded-2 fs-8 mb-lg-0"
                        placeholder={t('Search ...')}
                    ...
                    <TableCell>
                      <input
                        id={`ShippingPreConfigrationUPSSearchClintId`}
                        type="text"
                        name="clientId"
                        className="form-control bg-white h-30px rounded-2 fs-8 mb-lg-0"
                        placeholder={t('Search ...')}
                        value={searchQuery.clientId}
                        onChange={onInputChangeSearch}
                        onKeyDown={e => handleKeyPress(e)}
                      />
                    </TableCell>
                    <TableCell>
                      <input
                        id={`ShippingPreConfigrationUPSSearchPathName`}
                        type="text"
                        name="pathName"
                        className="form-control bg-white h-30px rounded-2 fs-8 mb-lg-0"
                        placeholder={t('Search ...')}
