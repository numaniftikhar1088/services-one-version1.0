...
import CompendiumTestSetupIndex from "./TestSetup";
...
const MicroBiologyCompendiumData: React.FC<{}> = () => {
  const { t } = useLang();
...
export default MicroBiologyCompendiumData;
