    ...
    <>
      <div className="d-flex flex-wrap justify-content-center justify-content-sm-between align-items-center responsive-flexed-actions mb-2 gap-2">
        ...
        <div className="d-flex align-items-center gap-2 ">
          {tab2Search ? (
            <button
              id={`AllInsuranceOpenSearchModal`}
            ...
            <button
              id={`AllInsuranceCloseSearchModal`}
          ...
          <button
            id={`AllInsuranceAddNew`}
            className={`btn btn-sm fw-bold btn-primary`}
            onClick={AddNewTab2}
            aria-controls="ModalCollapse"
            disabled={tab2Search}
          >
            <span className="">{t("Add New Insurance Provider")}</span>
          </button>
        </div>
      </div>
      <div className="card">
                  ...
                  <TableRow>
                    ...
                    <TableCell sx={{ width: "max-content" }}>
                      <div
                        ...
                        onClick={() => handleSort1("providerName")}
                        ref={searchRef1}
                      >
                        ...
                        <div className="d-flex justify-content-center align-items-center mx-4 mr-0">
                          <ArrowUp
                            CustomeClass={`${
                              ...
                              sort1.clickedIconData === "providerName"
                                ? "text-success fs-7"
                                : "text-gray-700 fs-7"
                            } p-0 m-0`}
                          />
                    ...
                    <TableCell sx={{ width: "max-content" }}>
                      <div
                        className="d-flex justify-content-between cursor-pointer"
                        onClick={() => handleSort1("providerCode")}
                        ref={searchRef1}
                      >
                        <div style={{ width: "max-content" }}>
                          {t("Provider Code")}
                        ...
                        <div className="d-flex justify-content-center align-items-center mx-4 mr-0">
                          <ArrowUp
                            CustomeClass={`${
                              sort1.sortingOrder === "desc" &&
                              sort1.clickedIconData === "providerCode"
                                ? "text-success fs-7"
                                : "text-gray-700 fs-7"
                            } p-0 m-0`}
                          />
                      ...
                      >
                        ...
                        <div className="d-flex justify-content-center align-items-center mx-4 mr-0">
                          <ArrowUp
                            CustomeClass={`${
                              sort1.sortingOrder === "desc" &&
                              sort1.clickedIconData === "address1"
                                ? "text-success fs-7"
                                : "text-gray-700 fs-7"
                            } p-0 m-0`}
                          />
                      ...
                      >
                        ...
                        <div className="d-flex justify-content-center align-items-center mx-4 mr-0">
                          <ArrowUp
                            CustomeClass={`${
                              sort1.sortingOrder === "desc" &&
                              sort1.clickedIconData === "landPhone"
                                ? "text-success fs-7"
                                : "text-gray-700 fs-7"
                            } p-0 m-0`}
                          />
