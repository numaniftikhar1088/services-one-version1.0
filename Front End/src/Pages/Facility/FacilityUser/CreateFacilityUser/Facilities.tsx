        ...
        <div className="card shadow-sm rounded border border-warning">
          ...
          <div className="card-body py-md-4 py-3 px-4">
            <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
              <div className="row">
                <div className={isMobile ? "d-flex align-items-center flex-column justify-content-center" : "d-flex align-items-center flex-wrap justify-content-around"}>
                  {isMobile && (
                  ...
                  <div className={isMobile ? "col-12 mb-3" : "col-lg-5 col-md-5 col-sm-12"}>
                    ...
                    <div className="mt-2 border-1 border-light-dark border rounded overflow-hidden">
                      ...
                      <ol className={isMobile ? "list-group rounded-0 list-group-even-fill  scroll2" : "list-group rounded-0 list-group-even-fill  h-325px scroll "}>
