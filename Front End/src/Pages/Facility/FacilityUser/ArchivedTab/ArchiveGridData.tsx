        ...
        >
          <TableHead>
            <TableRow className="h-40px">
              ...
              <TableCell>
                <input
                  id="FacilityUserArchivedTabFirstName"
                  type="text"
                  name="firstName"
              ...
              <TableCell>
                <input
                  id="FacilityUserArchivedTabLastName"
                  type="text"
                  name="lastName"
              ...
              <TableCell>
                <input
                  id="FacilityUserArchivedTabEmail"
                  type="text"
                  name="email"
                  className="form-control bg-white  min-w-100px w-100 rounded-2 fs-8 h-30px"
                  placeholder={t("Search ...")}
              ...
              <TableCell>
                <input
                  id="FacilityUserArchivedTabUserType"
                  type="text"
                  name="adminType"
                  className="form-control bg-white  min-w-100px w-100 rounded-2 fs-8 h-30px"
                  placeholder={t("Search ...")}
              ...
              <TableCell>
                <input
                  id="FacilityUserArchivedTabNpiNumber"
                  type="text"
                  name="npiNumber"
              ...
              <TableCell>
                <input
                  id="FacilityUserArchivedTabUserGroup"
                  type="text"
                  name="userGroup"
                  className="form-control bg-white  min-w-100px w-100 rounded-2 fs-8 h-30px"
                  placeholder={t("Search ...")}
