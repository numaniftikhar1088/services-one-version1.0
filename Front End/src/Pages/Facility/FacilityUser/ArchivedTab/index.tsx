...
const ArchivedTab = () => {
  ...
  const loadData = (loader: boolean, reset: boolean, sortingState?: any) => {
    setLoading(loader);
    UserManagementService.getAllFacilityUsersArchived({
      pageIndex: curPage,
      pageSize: pageSize,
      ...
      <div className="mb-2 d-flex flex-wrap gap-2 justify-content-center justify-content-sm-between align-items-center py-2">
        <div className="d-flex align-items-center gap-2">
          <div className="d-flex align-items-center">
            ...
            <select
              id="FacilityUserArchivedTabRecord"
        ...
        <div className="d-flex align-items-center gap-2">
          <button
            id="FacilityUserArchivedTabSearchButton"
            onClick={() => {
              setTriggerSearchData((prev) => !prev);
              setCurPage(1);
            }}
          ...
          <button
            ...
            id="FacilityUserArchivedTabReset"
          >
            <span>
              <span>{t("Reset")}</span>
            </span>
