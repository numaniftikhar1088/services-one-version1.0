        ...
        <div className="card shadow-sm rounded border border-warning">
          ...
          <div className="card-body py-md-4 py-3 px-4">
            <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
              <div className="row">
                <div
                  className={`d-flex align-items-center  ${isMobile ? "flex-column" : "justify-content-around"}`}
                >
                  {/* Mobile: Buttons on top */}
                  {isMobile && (
                    <div className="align-items-center d-flex flex-row mt-2 justify-content-center gap-2 px-3 mb-3 w-100">
                      <span
                  ...
                  <div
                    className={
                      isMobile ? "col-12 mb-3" : "col-lg-5 col-md-5 col-sm-12"
                    }
                  >
                    <span className="fw-bold">{t("All Facilities")}</span>
                    <input
                      id="LabAsignmenAllFacilitySearch"
                      type="text"
                      name=""
                    ...
                    <div className="mt-2 border-1 border-light-dark border rounded overflow-hidden">
                      ...
                      > */}
                        ...
                        {filteredSports?.map((items: any, index: number) => (
                          <li
                            id={`LabAsignmenAllFacility_${items.id}`}
                            key={items.id}
                            className={
                  ...
                  {/* Selected Facilities Section - Equal width on mobile */}
                  <div
                    className={
                      isMobile ? "col-12 mt-5" : "col-lg-6 col-md-5 col-sm-12"
                    }
                  >
                    ...
                    <input
                      id="LabAsignmenSelectedFacilitySearch"
                      type="text"
                      name=""
                      className="form-control bg-white mb-3 mb-lg-0 h-30px rounded-2 fs-8 w-100"
                      placeholder={t("Search...")}
                    ...
                    <div className="mt-2 border-1 border-light-dark border rounded overflow-hidden">
                      ...
                      > */}
                        ...
                        {filteredSports2?.map((item: any, index: number) => (
                          <li
                            id={`LabAsignmenSelectedFacility_${item.id}`}
                            key={item.id}
                            className={
