...
import TrainingAidsTab from "./TrainingAidsTAb";
...
const TrainingAidsMain: React.FC<{}> = () => {
  const { t } = useLang();
      ...
      <div className="d-flex flex-column flex-column-fluid">
        <div className="app-content flex-column-fluid">
          <div className="app-container container-fluid">
            ...
            >
              <TabSelected
                label={t("Facility Training Documents")}
                {...a11yProps(0)}
                className="fw-bold text-capitalize"
                id={`FacilityTrainingDocuments`}
              />
              <TabSelected
                label={t("Sales Rep Training Documents")}
                {...a11yProps(1)}
                className="fw-bold text-capitalize"
                id={`SaleRepTrainingDocument`}
              />
            </Tabs>
...
export default TrainingAidsMain;
