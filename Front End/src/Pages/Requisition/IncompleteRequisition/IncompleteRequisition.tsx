...
const IncompleteRequisitionGrid: React.FC<IncompleteRequisition> = ({
  ...
  const Export_To_Excel_Selected_Record = () => {
    if (selectedBox.RequisitionOrderId.length != 0) {
      ...
      toast.error("Please select atleast one recored");
    }
  };
    ...
    <>
      <div>
        <div className="card-body pt-4">
          ...
          <div className="d-flex flex-wrap gap-4 justify-content-center justify-content-sm-between align-items-center mb-2 col-12 responsive-flexed-actions">
            <div className="d-flex gap-3 responsive-flexed-actions-reverse mt-3">
                ...
                <div className="d-flex gap-2 gap-lg-3 ">
                  <div>
                    <AnyPermission
                      ...
                      pageName="Incomplete Requisition"
                      ...
                      requisitionList?.map((item: any) => (
                        <TableRow sx={{ "& > *": { borderBottom: "unset" } }}>
                          ...
                          <TableCell className="text-center">
                            <div
                              className="badge badge-pill px-4 py-2 rounded-4 fw-400 fa-1x"
                          ...
                          <TableCell>{item?.TimeOfCollection}</TableCell>
