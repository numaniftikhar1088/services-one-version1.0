                  ...
                  <TableRow>
                    <TableCell>
                      <div className="fv-row mb-4">
                        {/* <!--begin::Label--> */}
                        <label className="required   mb-2">{t("Test Assignment")}</label>
...
// const [editableRowId, setEditableRowId] = React.useState();
// const handleUpdateRow = (dataToBeEdited) => {
                ...
                <Table aria-label="collapsible table">
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell>{t("REQUISITION ASSIGMENT")}</TableCell>
