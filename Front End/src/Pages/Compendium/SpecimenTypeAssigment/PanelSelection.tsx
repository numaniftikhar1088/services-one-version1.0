...
const PanelSelection: React.FC<IProps> = ({
  facilities,
  sports2,
  setSports2,
  id,
        ...
        <div className="card shadow-sm rounded border border-warning">
          ...
          <div className="card-body py-md-4 py-3 px-4">
            <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
              <div className="row">
                {/* Mobile Layout - Buttons at top */}
                {isMobile ? (
                  <div className="col-12">
                    {/* Buttons positioned at the top on mobile */}
                    <div className="d-flex justify-content-center gap-3 mb-4">
                      <span
                        id={`SpecimenTypeAssigmentSelectAllPanel`}
                      ...
                      <span
                        id={`SpecimenTypeAssigmentDeselectAllPanel`}
                    ...
                    <div className="col-12 mb-4">
                      ...
                      <input
                        id={`SpecimenTypeAssigmentAllPanelSearch`}
                        type="text"
                        name=""
                      ...
                      <div className="mt-2 border-1 border-light-dark border rounded overflow-hidden">
                        ...
                        <ul className="list-group rounded-0 list-group-even-fill h-225px scroll">
                          {filteredSports?.map((items: any, index: number) => (
                            <li
                              id={`SpecimenTypeAssigmentAllPanel_${items?.id}`}
                              key={index}
                              className={
                                dragOverItemIndex?.listone === index
                                  ? "list-group-item next-position px-2 py-1 cursor-pointer "
                    ...
                    <div className="col-12">
                      ...
                      <input
                        id={`SpecimenTypeAssigmentSelectedPanelSearch`}
                        type="text"
                        name=""
                        className="form-control bg-transparent mb-3"
                        placeholder={t("Search...")}
                      ...
                      <div className="mt-2 border-1 border-light-dark border rounded overflow-hidden">
                        ...
                        <ol className={isMobile?"list-group rounded-0 list-group-even-fill  scroll2":"list-group rounded-0 list-group-even-fill h-225px scroll"}>
                          {filteredSports2?.map((item: any, index: number) => (
                            <li
                              id={`SpecimenTypeAssigmentSelectedPanel_${item?.id}`}
                              key={item.id}
                              className={
