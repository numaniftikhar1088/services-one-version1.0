// Main component for displaying the QcGroup tab, including filter controls and a table of QcGroup data.
import {
  Box,
  MenuItem,
  Paper,
...
import PricingRow, { QcGroupRowsData } from "./QcGroupRow";

// QcGroupIndex component displays filter controls and a table of QcGroup data.
const QcGroupIndex = () => {
  const { t } = useLang();
          ...
          <div className="table_bordered overflow-hidden">
            ...
            >
              ...
              >
                ...
                <TableBody>
                  {/* Render each QcGroup row as a table row */}
                  {QcGroupRowsData.map((row, idx) => (
                    <PricingRow key={row.instrument + idx} data={row} />
                  ))}
                </TableBody>
              </Table>
            </TableContainer>
