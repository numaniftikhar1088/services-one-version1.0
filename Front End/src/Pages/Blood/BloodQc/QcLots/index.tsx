// Main component for displaying the QC Lots tab, including filter controls and a table of pricing data.
import {
  Box,
  MenuItem,
  Paper,
...
import QcLotsRow, { QcLotsRows } from "./QcLotsRow";

// PricingIndex component displays filter controls and a table of QC lot pricing data.
const QcLotsTab = () => {
  const { t } = useLang();
          ...
          <div className="table_bordered overflow-hidden">
            ...
            >
              ...
              >
                ...
                <TableBody>
                  {/* Render each Qc Lot row as a table row */}
                  {QcLotsRows.map((row, idx) => (
                    <QcLotsRow key={row.instrument + idx} data={row} />
                  ))}
                </TableBody>
              </Table>
            </TableContainer>
