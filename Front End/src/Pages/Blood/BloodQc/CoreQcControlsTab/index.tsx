// Main component for displaying the Core Qc Controls tab, including filter controls and a table of Core Qc Controls data.
import {
  Box,
  MenuItem,
  Paper,
...
import CoreQcControlsRow, { coreQcControlsData } from "./CoreQcControlsRow";
import { useState } from "react";
// CoreQcControls component displays filter controls and a table of Core Qc Controls data.
const CoreQcControls = () => {
  const { t } = useLang();
  ...
  return (
    <>
      ...
      {/* Table displaying Blood QC range data */}
      <div className="card">
          ...
          <div className="table_bordered overflow-hidden">
            ...
            >
              ...
              >
                ...
                <TableBody>
                  {coreQcControlsData.map((row, idx) => (
                    <CoreQcControlsRow key={row.instrument + idx} data={row} />
                  ))}
                </TableBody>
              </Table>
            </TableContainer>
