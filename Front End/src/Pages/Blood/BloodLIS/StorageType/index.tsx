...
import { StorageTypeGetAll } from 'Services/BloodLisSetting/BloodLisSetting';
import StorageTypeRow from './row';
import useIsMobile from 'Shared/hooks/useIsMobile';

const StorageTypeIndex = () => {
  const { t } = useLang();
  ...
  let obj = {
    ...
    pageSize: pageSize,
    queryModel: {
      storageTypeName: (searchCriteria.storageType || '').trim(),
    },
  ...
  const showApiData = async () => {
    setLoading(true);
    try {
      let resp = await StorageTypeGetAll(obj);
        ...
        <div className="d-flex align-items-center responsive-flexed-actions gap-2">
          ...
          <div className="d-flex align-items-center gap-2">
            <PermissionComponent
              ...
              permissionIdentifier="AddStorageType"
            >
              <button
                id={`BloodLisStorageTypeAddNew`}
                        ...
                        <div className="d-flex justify-content-center align-items-center mx-4 mr-0">
                          <ArrowUp
                            CustomeClass={`${
                              ...
                              sort.clickedIconData === 'storageType'
                                ? 'text-success fs-7'
                                : 'text-gray-700 fs-7'
                            } p-0 m-0`}
                          />
...
export default StorageTypeIndex;
