...
import CannedRow from './CannedRow';
      ...
      <div className="d-flex flex-wrap justify-content-center justify-content-sm-between align-items-center responsive-flexed-actions mb-2 gap-2">
        <div className="d-flex align-items-center responsive-flexed-actions gap-2">
          <div className="d-flex align-items-center">
            ...
            <select
              id={`BloodLisSettingCannedCommentRecords`}
          ...
          <div className="d-flex align-items-center gap-2">
            <PermissionComponent
              ...
              permissionIdentifier="AddCannedComments"
            >
              <button
                id={`BloodLisSettingCannedCommentAddNew`}
        ...
        <div className="d-flex align-items-center gap-2">
          <button
            id={`BloodLisSettingCannedCommentSearch`}
          ...
          <button
            id={`BloodLisSettingCannedCommentReset`}
              ...
              >
                <TableHead>
                  <TableRow className="h-40px">
                    ...
                    <TableCell>
                      <input
                        id={`BloodLisSettingCannedCommentDisplayNameSearch`}
                        type="text"
                        name="displayName"
                    ...
                    <TableCell>
                      <input
                        id={`BloodLisSettingCannedCommentDisplayTextSearch`}
                        type="text"
                        name="displayText"
                        className="form-control bg-white rounded-2 fs-8 h-30px"
