        ...
        >
          <TableHead>
            <TableRow className="h-40px">
              ...
              <TableCell>
                <input
                  id={`ManageOrderNewOrderSearchFacilityName`}
                  type="text"
                  name="facilityName"
              ...
              <TableCell>
                <input
                  id={`ManageOrderNewOrderSearchCreatedBy`}
                  type="text"
                  name="createdBy"
                  className="form-control bg-white h-30px rounded-2 fs-8 mb-lg-0"
                  placeholder={t("Search ...")}
              ...
              <TableCell>
                <input
                  id={`ManageOrderNewOrderSearchRepresentativeName`}
                  type="text"
              ...
              <TableCell>
                <input
                  id={`ManageOrderNewOrderSearchDateOFRequest`}
                  type="date"
                  name="dateofRequest"
                  className="form-control bg-white h-30px rounded-2 fs-8 mb-lg-0"
                  placeholder={t("Search ...")}
            ...
            <TableRow className="h-30px">
              <TableCell className="w-20px min-w-20px">
                <label className="form-check form-check-sm form-check-solid d-flex justify-content-center">
                  <input
                    id={`ManageOrderNewOrderCheckAll`}
