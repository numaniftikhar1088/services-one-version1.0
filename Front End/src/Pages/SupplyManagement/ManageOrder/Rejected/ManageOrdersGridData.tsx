        ...
        >
          <TableHead>
            <TableRow className="h-40px">
              ...
              <TableCell>
                <input
                id={`ManageOrderRejectedSearchFacilityName`}
                  type="text"
                  name="facilityName"
              ...
              <TableCell>
                <input
                id={`ManageOrderRejectedSearchCreatedBy`}
                  type="text"
                  name="createdBy"
                  className="form-control bg-white h-30px rounded-2 fs-8 mb-lg-0"
                  placeholder={t("Search ...")}
              ...
              <TableCell>
                <input
                id={`ManageOrderRejectedSearchRepersentativeName`}
                  type="text"
              ...
              <TableCell>
                <input
                id={`ManageOrderRejectedSearchRejectedReason`}
                  type="text"
                  name="rejectedReason"
                  className="form-control bg-white h-30px rounded-2 fs-8 mb-lg-0 min-w-200px"
                  placeholder={t("Search ...")}
                  value={searchRequest.rejectedReason}
                  onChange={onInputChangeSearch}
                  onKeyDown={(e) => handleKeyPress(e)}
                />
              </TableCell>
              <TableCell>
                <input
                id={`ManageOrderRejectedSearchDateOfRequest`}
                  type="date"
                  name="dateofRequest"
                  className="form-control bg-white h-30px rounded-2 fs-8 mb-lg-0"
                  placeholder={t("Search ...")}
            ...
            <TableRow className="h-30px">
              <TableCell className="w-20px min-w-20px">
                <label className="form-check form-check-sm form-check-solid d-flex justify-content-center">
                  <input
                  id={`ManageOrderRejectedCheckAll`}
              ...
              <TableCell sx={{ width: "max-content" }}>
                <div
                  ...
                  ref={searchRef}
                >
                  <div style={{ width: "max-content" }}>{t("Requested By")}</div>
              ...
              <TableCell sx={{ width: "max-content" }}>
                <div
                  ...
                  ref={searchRef}
                >
                  <div style={{ width: "max-content" }}>{t("Request Date")}</div>
