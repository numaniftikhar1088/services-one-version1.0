...
const ClosePatientRow = () => {
  ...
  const handleCloseAlert2 = () => setManualRefund(false);
  ...
  return (
    <>
      <TableRow className="h-30px">
        ...
        <TableCell sx={{ width: "max-content" }}>
          <div className="d-flex justify-content-between  ">09876</div>
        </TableCell>
         <TableCell sx={{ width: "max-content" }}>
        ...
        <TableCell sx={{ width: "max-content" }}>
          <div className="d-flex justify-content-between  ">
            <div style={{ width: "max-content" }}>Patient Pay</div>
          </div>
        </TableCell>
        <TableCell sx={{ width: "max-content" }}>
          <div className="d-flex justify-content-between  ">
            <div style={{ width: "max-content" }}>Normal</div>
          </div>
        </TableCell>
        <TableCell sx={{ width: "max-content" }}>
          <div className="d-flex justify-content-between  ">
        ...
        <TableCell sx={{ width: "max-content" }}>
          <div className="d-flex justify-content-between  ">
            <div style={{ width: "max-content" }}>$0</div>
          </div>
        </TableCell>
      </TableRow>
       <BootstrapModal
...
export default ClosePatientRow;
