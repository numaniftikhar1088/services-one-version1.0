        ...
        <div className="d-flex align-items-center responsive-flexed-actions gap-2">
          ...
          <div className="d-flex align-items-center gap-2">
            ...
            >
              ...
              <span style={{ fontSize: 11 }}>{t("Create Discount")}</span>
            </button>
          </div>
        </div>
        <div className="d-flex align-items-center gap-2">
              ...
              >
                <TableHead>
                  ...
                  <TableRow className="h-30px">
                    ...
                    <TableCell>
                      <div className="d-flex justify-content-between cursor-pointer">
                        <div style={{ width: "max-content" }}>{t("SKU")}</div>
                ...
                <TableBody>
                  {addRow ? <AddDiscount setAddRow={setAddRow} /> : null}
                  <DiscountRow />
                </TableBody>
              </Table>
            </TableContainer>
