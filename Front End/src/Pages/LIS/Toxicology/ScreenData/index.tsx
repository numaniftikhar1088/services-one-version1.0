...
export default function ScreenTable() {
  ...
  const initialSearchQuery = {
    ...
    TestCode: "",
    PerformingLabId: 0,
    TestTypeId: FindPanelTypeID("Screening"),
    TestTypeName: "Screening",
    ShadowBox: "",
    StabilityDay: "",
  };
  ...
  const handleChange = (name: string, value: any, id: number) => {
    console.log(name, value, id, "handleChange");

    setScreenData((curr: any) =>
      curr.map((x: any) =>
        x.ID === id
          ? {
              ...x,
  ...
  const LoadScreenDataTab = async (reset: boolean) => {
    setLoading(true);
      ...
      <div className="d-flex flex-wrap gap-2 justify-content-center justify-content-sm-between align-items-center mb-2 col-12 responsive-flexed-actions">
        <div className="d-flex gap-2 responsive-flexed-actions">
          <div className="d-flex align-items-center">
            ...
            <select
              id={`compendiumDataScreenDataRecords`}
          ...
          <div className="d-flex align-items-center gap-2 justify-content-center">
            ...
            >
              <button
                id={`compendiumDataScreenDataAddNew`}
                onClick={() => {
                  if (!isAddButtonDisabled) {
                    setScreenData((prevRows: any) => [
        ...
        <div className="d-flex flex-wrap gap-3 justify-content-center justify-content-sm-between align-items-center">
          <div className="d-flex align-items-center gap-2 gap-lg-3">
            <button
              id={`compendiumDataScreenDataSearch`}
              onClick={() => {
                setCurPage(1);
                setTriggerSearchData((prev) => !prev);
              }}
            ...
            <button
              ...
              id={`compendiumDataScreenDataReset`}
            >
              <span>
                <span>{t("Reset")}</span>
              </span>
              ...
              >
                <TableHead>
                  <TableRow className="h-40px">
                    ...
                    {/* <TableCell>
                      <input
                        id={`compendiumDataScreenDataSearchDrugClass`}
                        type="text"
                        name="DrugClass"
                    ...
                    <TableCell>
                      <input
                        id={`compendiumDataScreenDataSearchAnalyte`}
                        type="text"
                        name="Analyte"
                        className="form-control bg-white h-30px rounded-2 fs-8 mb-lg-0"
                        placeholder={t("Search ...")}
                    ...
                    <TableCell>
                      <input
                        id={`compendiumDataScreenDataSearchCutoff`}
                        name="Cutoff"
                        className="form-control bg-white h-30px rounded-2 fs-8 mb-lg-0"
                        placeholder={t("Search ...")}
                    ...
                    <TableCell>
                      <input
                        id={`compendiumDataScreenDataSearchUnit`}
                        type="text"
                        name="Unit"
                        className="form-control bg-white h-30px rounded-2 fs-8 mb-lg-0"
                        placeholder={t("Search ...")}
                    ...
                    <TableCell>
                      <Select
                        inputId={`compendiumDataScreenDataSearchSpecimenType`}
                    ...
                    <TableCell>
                      <input
                        id={`compendiumDataScreenDataSearchTestCode`}
                        type="text"
                        name="TestCode"
                        className="form-control bg-white h-30px rounded-2 fs-8 mb-lg-0"
                        placeholder={t("Search ...")}
                    ...
                    <TableCell>
                      <Select
                        inputId={`compendiumDataScreenDataSearchPerformingLab`}
                        menuPortalTarget={document.body}
                        theme={(theme) => styles(theme)}
                    ...
                    <TableCell>
                      <input
                        id={`compendiumDataScreenDataSearchShadowBox`}
                        type="text"
                        name="ShadowBox"
                        className="form-control bg-white h-30px rounded-2 fs-8 mb-lg-0"
                        placeholder={t("Search ...")}
                    ...
                    <TableCell>
                      <input
                        id={`compendiumDataScreenDataSearchStabilityDay`}
                        type="text"
                        name="StabilityDay"
                        className="form-control bg-white h-30px rounded-2 fs-8 mb-lg-0"
                        placeholder={t("Search ...")}
                ...
                <TableBody>
                  {loading ? (
                    ...
                    screenData.map((item: any, index: any) => {
                      return (
                        <Row
                          row={item}
                          index={index}
                          rows={screenData}
                          setRows={setScreenData}
                          dropDownValues={DropDowns}
                          handleChange={handleChange}
                          loadGridData={LoadScreenDataTab}
                          request={request1}
