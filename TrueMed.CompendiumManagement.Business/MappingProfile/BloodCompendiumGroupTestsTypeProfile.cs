...
{
    public class BloodCompendiumGroupTestsTypeProfile : Profile
    {
        public BloodCompendiumGroupTestsTypeProfile()
        {
            CreateMap<SaveGroupTestsTypeRequest,TblCompendiumPanel>();
        }
    }
}
