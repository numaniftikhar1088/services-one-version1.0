...
using TrueMed.ReportingServer.Business.ReportComponents.UTIStandardComponents;
...
{
    public class UTIStandardReport : IDocument
    {
        private readonly StandardUTIReportDataModel _model;
        public UTIStandardReport(StandardUTIReportDataModel model)
        {
            _model = model;
        ...
        public void Compose(IDocumentContainer container)
        {
         ...
         .Page(page =>
         {
             ...
             {
                 column.Item().Component(new UTIStandardReportHeaderComponent(_model.Header));
             });


             page.Content().PaddingVertical(10).Column(column =>
             {
                 column.Item().Component(new UTIStandardReportContentComponent(_model.Content));
