...
{
    //public class LoadReqSectionResponse
    //{
    //    public List<ReqSection> Requisitions { get; set; }
    //}
    ...
    public class LoadReqSectionResponse
    {
        ...
        public List<SectionWithControlsAndDependenciesClient> Sections { get; set; } = new List<SectionWithControlsAndDependenciesClient>();
    }
    ...
    public class ControlWithDependenciesClient
    {
        ...
        public int PreviewSortOrder { get; set; }
        public string PreviewDisplayType { get; set; }
        public string Mask { get; set; }
        public string ValidationExpression { get; set; }
        public List<OptionClient> Options { get; set; }
        public string? AutoCompleteOption { get; set; }
        public int SortOrder { get; set; }
        public string? CssStyle { get; set; }
        public string DispayRule { get; set; } = "";
        public string EnableRule { get; set; } = "";
        public string? DisplayType { get; set; }
        public List<DependencyControlsClient> DependenceyControls { get; set; }
   ...
   public class Panel
    ...
    public class OptionClient
    {
        ...
        public List<ControlWithDependenciesClient> DependenceyControls { get; set; }
