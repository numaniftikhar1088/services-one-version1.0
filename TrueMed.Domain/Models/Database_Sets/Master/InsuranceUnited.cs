...
public partial class InsuranceUnited
{
    ...
    public string? MyndShftPayerName { get; set; }

    public string? MyndShiftPayerId { get; set; }

    public string? MyndShftInsType { get; set; }
